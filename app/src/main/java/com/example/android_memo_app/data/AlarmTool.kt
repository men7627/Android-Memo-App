...
import com.example.android_memo_app.DetailActivity
import com.example.android_memo_app.R
        ...
        when (intent.action) {
            ACTION_RUN_ALARM -> {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    val channel =
                        NotificationChannel("alarm", "알람 메시지", NotificationManager.IMPORTANCE_HIGH)
